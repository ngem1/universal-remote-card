import { androidTVDefaultKeys, androidTVDefaultSources, appleTVDefaultKeys, appleTVDefaultSources, braviaTVDefaultKeys, braviaTVDefaultSources, fireTVDefaultKeys, fireTVDefaultSources, jellyfinDefaultSources, jellyfinTVDefaultKeys, kodiDefaultKeys, kodiDefaultSources, rokuDefaultKeys, rokuDefaultSources, samsungTVDefaultKeys, samsungTVDefaultSources, philipsTVDefaultKeys, unifiedRemoteDefaultKeys, unifiedRemoteDefaultSources, webosDefaultKeys, webosDefaultSources, philipsTVDefaultSources, } from '../models/maps';
export function getDefaultActions(platform) {
    let defaultKeys;
    let defaultSources;
    switch (platform) {
        case 'Unified Remote':
