...
This card supports several media platforms with default key and source lists. Different platforms require different entities. Some platforms require custom integrations and are called out below the table.

Most platforms also support keyboard input and search, and use the Home Assistant integrations for these platforms via their remote and/or media player entities. Some of these platforms use a separate integration for keyboard and/or search (namely Android TV based platforms via Android Debug Bridge) whose entity ID can be provided in the Keyboard ID field. Fire TV uses Android Debug Bridge for all inputs and therefore does not have a separate Keyboard ID field in the general tab.

| Platform                                                                   | Remote ID                           | Media Player ID                                                                                                                        | Keyboard ID                                                                                                             | Remote/Device Name              |
| -------------------------------------------------------------------------- | ----------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------- | ------------------------------- |
| [Android TV](https://www.home-assistant.io/integrations/androidtv_remote/) | Default keys, sources, and keyboard | Default slider                                                                                                                         | [ADB](https://www.home-assistant.io/integrations/androidtv/) remote (preferred) or media player for search              | NA                              |
| [Sony BRAVIA](https://www.home-assistant.io/integrations/braviatv/)        | Default keys                        | Default sources and slider                                                                                                             | [ADB](https://www.home-assistant.io/integrations/androidtv/) remote (preferred) or media player for keyboard and search | NA                              |
